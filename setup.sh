...
echo -e " Auther : ${green}Bastian Pratama935 ${NC}"
echo -e " © Version ${YELLOW}(${NC} 2025 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
...
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/MuhammadIdsal/BangJali-Store/main/izin | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/MuhammadIdsal/BangJali-Store/main/izin | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/MuhammadIdsal/BangJali-Store/main/izin | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/MuhammadIdsal/BangJali-Store/main/"
...
URL="https://api.telegram.org/bot$KEY/sendMessage"
    ...
    TEXT="
<code>────────────────────</code>
<b> AUTOSCRIPT PREMIUM BASTIAN </b>
<code>────────────────────</code>
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://wa.me/+6281585210167"}]]}' 
...
bash -c "$(curl -L https://github.com/XTLS/Xray-install/raw/main/install-release.sh)" @ install -u www-data --version $latest_version
    ...
    wget -O /etc/haproxy/haproxy.cfg "https://raw.githubusercontent.com/MuhammadIdsal/BangJali-Store/main/media/haproxy.cfg" >/dev/null 2>&1
    wget -O /etc/nginx/conf.d/xray.conf "https://raw.githubusercontent.com/MuhammadIdsal/BangJali-Store/main/media/xray.conf" >/dev/null 2>&1
...
wget -q https://raw.githubusercontent.com/MuhammadIdsal/BangJali-Store/main/media/limmit && chmod +x limmit && ./limmit
wget -q https://raw.githubusercontent.com/MuhammadIdsal/BangJali-Store/main/media/udp-custom.sh && chmod +x udp-custom.sh && ./udp-custom.sh
wget -q https://raw.githubusercontent.com/MuhammadIdsal/BangJali-Store/main/slowdns/noobzvpns.zip
unzip noobzvpns.zip
bash install.sh
rm -rf noobzvpns
...
wget -O /etc/issue.net "https://raw.githubusercontent.com/MuhammadIdsal/BangJali-Store/main/media/issue.net"
